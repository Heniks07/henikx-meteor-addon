...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(Meteor.HUD_GROUP, "example", "HUD element example.", HudExample::new);
